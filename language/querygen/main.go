...
import (
	...
	. "github.com/fishedee/fishgo-boost/app/macro"
...
func usage() {
	...
	fmt.Fprintf(os.Stderr, "\thttps://github.com/fishedee/fishgo/tree/master/src/github.com/fishedee/fishgo-boost/language/querygen\n")
