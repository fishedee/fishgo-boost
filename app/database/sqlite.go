...
func (p *sqliteDriver) Parse(driverName, dataSourceName string) (*core.Uri, error) {
	return &core.Uri{DbType: "sqlite_cst", DbName: dataSourceName}, nil
}

func init() {
	core.RegisterDriver("sqlite_cst", &sqliteDriver{})
	core.RegisterDialect("sqlite_cst", func() core.Dialect { return &sqlite3{} })
}
